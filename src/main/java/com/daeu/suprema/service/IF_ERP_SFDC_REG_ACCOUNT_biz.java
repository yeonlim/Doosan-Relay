...
import com.daeu.suprema.io.IF_ERP_SFDC_REG_ACCOUNT.ACCOUNT_REG;
...
public class IF_ERP_SFDC_REG_ACCOUNT_biz extends WebCalloutUtil {
    ...
    public void execute() {
        ...
        while (true) {
            ...
            List<Map<String, Object>> accountListMap = repository.SELECT_ACCOUNT_REG_LIST(prcCnt);
            ...
            List<ACCOUNT_REG> accountList = new ArrayList<>();
            for(Map<String, Object> a : accountListMap) {
                accountList.add(new ACCOUNT_REG(a));
            }
