...
public class IF_ERP_SFDC_REG_PRICEBOOK_ACC_biz extends WebCalloutUtil {
    ...
    public void execute() {
        ...
        while (true) {
            ...
            List<Map<String, Object>> pricebookAccListMap = repository.SELECT_PRICEBOOK_ACC_LIST();
            ...
            // 3. 요청
            logger.info("IF_ERP_SFDC_REG_PRICEBOOK_ACC : {}", IF_ERP_SFDC_REG_PRICEBOOK_ACC);
            ...
            if("0000".equals(objRes.getResultCode())) {
                repository.UPDATE_PRICEBOOK_ACC_LIST(pricebookAccListMap);
            }
        }
    }
}
