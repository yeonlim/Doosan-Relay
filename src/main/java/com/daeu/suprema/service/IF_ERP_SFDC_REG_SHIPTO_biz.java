...
public class IF_ERP_SFDC_REG_SHIPTO_biz extends WebCalloutUtil {
    ...
    public void execute() {
        ...
        while (true) {
            ...
            List<Map<String, Object>> shiptoListMap = repository.SELECT_SHIPTO_LIST();
            ...
            // 3. 요청
            logger.info("IF_ERP_SFDC_REG_SHIPTO : {}", IF_ERP_SFDC_REG_SHIPTO);
            ...
            if("0000".equals(objRes.getResultCode())) {
                repository.UPDATE_SHIPTO_LIST(shiptoListMap);
            }
        }
    }
}