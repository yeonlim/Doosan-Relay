...
public class IF_ERP_SFDC_REG_ACCOUNT_repo {
    ...
    private final String[] IF_FIELDS = {"BP_CD", "BP_RGST_NO", "BP_FULL_NM", "ADDR_ENG", "TEL_NO1", "CONTRY_CD", "BP_PRSN_NM", "CURRENCY", "PAY_METH", "DEAL_TYPE", "SFDC_ACCOUNT_ID", "BOOS_ORDER_YN"};
